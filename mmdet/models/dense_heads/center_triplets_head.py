...
class CenterHead(BaseDenseHead):
    ...
    def loss_single(self, tl_hmp, br_hmp, tl_emb, br_emb, tl_off, br_off,
                    center_hmp, center_off, targets, alpha=0.1, beta=0.1, gamma=1.0):
        ...
        Args:
            ...
            aplha (float): weight for pull loss
            beta (float): weight for push loss
            gamma (float): weight for offset loss (combine center and corner)
